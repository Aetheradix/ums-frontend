  ...
  return (
    <div className="bg-white border-bottom-1 border-100 px-4 py-3 flex align-items-center justify-content-between">
      <div className="flex align-items-center gap-3">
        <div className="bg-900 text-white border-round-md flex align-items-center justify-content-center font-bold shadow-sm" style={{ width: '40px', height: '40px', backgroundColor: '#1e293b' }}>
          N
        </div>
        <div>
          <div className="font-bold text-base text-900 line-height-1">UMS ERP</div>
          <div className="text-xs text-500 font-bold mt-1">Workspace OS</div>
        </div>
      </div>

      <div className="flex-1 max-w-2xl px-8 ml-8">
        <div className="relative w-full h-3rem">
          <i className="pi pi-search text-500 absolute left-0 top-50 translate-middle-y ml-3" style={{ pointerEvents: 'none' }}></i>
          <InputText 
            placeholder="Search Services,records,people..." 
            className="w-full border-none h-full border-round-lg text-sm font-semibold" 
            style={{ backgroundColor: '#f1f5f9', paddingLeft: '3rem' }}
          />
        </div>
      </div>
      ...
      <div className="flex align-items-center gap-4 text-700">
        <div className="flex gap-4 pr-3 border-right-1 border-100">
          ...
          <div className="relative cursor-pointer">
            ...
            <span className="absolute top-0 right-0 bg-red-500 border-circle flex align-items-center justify-content-center text-white font-bold" style={{ width: '15px', height: '15px', fontSize: '9px', transform: 'translate(40%, -20%)' }}>1</span>
          </div>
        ...
        <div className="flex align-items-center gap-2 cursor-pointer">
          <Avatar label="AL" shape="circle" style={{ backgroundColor: '#6366f1', color: '#ffffff', fontWeight: 'bold' }} />
