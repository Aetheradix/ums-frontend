...
export default function Footer() {
  return (
    <footer className="bg-navy text-white md:pt-20 md:pb-10 py-5 relative overflow-hidden border-t border-slate-900">
      ...
      <div className="absolute -bottom-32 -right-32 w-96 h-96 bg-blue-500/[0.08] rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute -top-32 -left-32 w-96 h-96 bg-indigo-500/[0.04] rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 md:gap-12 mb-5 md:mb-16">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2.5 sm:space-y-3.5">
              <FooterLink label="Academic Management" href="/solutions" />
              <FooterLink label="Governance & Admin" href="/solutions" />
              <FooterLink label="Finance & Fees" href="/solutions" />
              <FooterLink label="HR & Employee Lifecycle" href="/solutions" />
              <FooterLink label="Analytics & BI Dashboards" href="/solutions" />
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2.5 sm:space-y-3.5">
              ...
              <FooterLink label="Contact Sales" href="/contact" />
...
function SocialIcon({
  ...
  return (
    <a
      href="#"
      className="w-8 h-8 rounded-full bg-white/5 border border-white/[0.04] flex items-center justify-center text-slate-400 hover:bg-blue hover:text-white hover:border-blue transition-all duration-300 shadow-sm"
    >
      {icons[icon]}
    </a>
  );
